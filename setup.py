...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-purchase_edit_inline',
    download_url='https://github.com:nantic/trytond-purchase_edit_inline.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-purchase_edit_inline.git'
    },
    classifiers=[
